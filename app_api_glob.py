...
def quarterly_additions_query():
    ...
    try:
        ...
        with open('C:\\Users\\COREBI\\Desktop\\glob_challenge\\SQL\\dml_number_employees.sql', 'r') as x:
            sql_query = x.read()
...
def hiring_above_mean():
    ...
    try:
        ...
        #open and read the file containing sql query
        with open('C:\\Users\\COREBI\\Desktop\\glob_challenge\\SQL\\dml_hired_department.sql', 'r') as x:
            sql_query = x.read()
